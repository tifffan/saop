...
savefig(strcat('fig_',graph,'_deg10.fig'));
close all;
...
poly_order_min = 3;
poly_order_max = 25;
n_its=poly_order_max - poly_order_min + 1;
poly_orders=[poly_order_min:poly_order_max]';
...
% Figure 5: square error vs order plot, including both SAOP and WLS
figure;
...
grid on;
savefig(strcat('fig_',graph,'_err_const_b_saop.fig'));
close all;
...
grid on;
savefig(strcat('fig_',graph,'_err_const_b.fig'));
close all;
